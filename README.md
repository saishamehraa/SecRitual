...
![SecRitual AI Command Center](https://img.shields.io/badge/UI-Cinematic_Command_Center-00d4ff?style=for-the-badge)
![Microsoft Foundry IQ](https://img.shields.io/badge/Powered_By-Microsoft_Foundry_IQ-blue?style=for-the-badge)
![Agent Reasoning](https://img.shields.io/badge/Track-Reasoning_Agents-7c3aed?style=for-the-badge)
<br>
...
![Trust Orchestration Dashboard](./docs/assets/dashboard.png)

### 🎬 Agent Debate & Consensus
![Agent Debate Mode](./docs/assets/agent-debate.png)

### 🛡️ AI Gateway Reasoning
![PromptShield reasoning over a live prompt injection attempt](./docs/assets/ai-gateway.png)
...
```mermaid
graph TD
    subgraph Frontend [Reasoning Command Center]
        UI[Cinematic Trust Dashboard]
        WS_Client[Reasoning Stream]
        UI <--> WS_Client
    end

    subgraph Trust Orchestration [Node.js / Express]
        Router[API Routes]
        SSE_Stream[Agent Debate Stream]
        DebateEngine[Consensus Intelligence Engine]
        Router --> DebateEngine
        DebateEngine --> SSE_Stream
    end

    subgraph Cognitive Security Agents
        PromptShield[PromptShield Firewall]
        SIFTGuardian[SIFTGuardian External Intel]
        CodeSage[CodeSage Code Analyzer]
    end

    subgraph Grounding Infrastructure
        OpenRouter[OpenRouter / Microsoft Azure]
        FoundryIQ[Microsoft Foundry IQ Evidence]
        Supabase[(Persistent Threat Memory)]
    end

    WS_Client -.->|Listens| SSE_Stream
    DebateEngine --> PromptShield
    DebateEngine --> SIFTGuardian
    DebateEngine --> CodeSage
    
    PromptShield --> OpenRouter
    SIFTGuardian --> OpenRouter
    CodeSage --> OpenRouter
    DebateEngine --> FoundryIQ
